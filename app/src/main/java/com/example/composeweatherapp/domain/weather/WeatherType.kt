...
sealed class WeatherType(
    ...
    object DepositingRimeFog : WeatherType(
        "Despositing Rime Fog", R.drawable.ic_fog
    )
    ...
    object FreezingDrizzleLight :
        WeatherType("Light Freezing Drizzle", R.drawable.ic_freezing_drizzle)

    object FreezingDrizzleDense :
        WeatherType("Dense Freezing Drizzle", R.drawable.ic_freezing_drizzle)
    ...
    object ThunderstormHailSlight :
        WeatherType("Thunderstorm with Slight Hail", R.drawable.ic_thunderstorm_hail)

    object ThunderstormHailHeavy :
        WeatherType("Thunderstorm with Heavy Hail", R.drawable.ic_thunderstorm_hail)

    object WeatherFetchError :
        WeatherType("Weather Fetch Error - check connection", R.drawable.ic_error)
